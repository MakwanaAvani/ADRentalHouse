...
public class RentingAHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_renting_ahome);
    ...
    private void EventChangeListener() {
        ...
        Query query = mStorage.collection("RentProperty").whereEqualTo("Property_Type", "Independent House");
...
//    @Override
//    public void onItemClick(DocumentSnapshot snapshot,int poistion) {
//        Log.d("ITEM_CLICK", "item the postion:"+poistion);
//    }
}